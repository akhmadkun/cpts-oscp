...
set policy-options policy-statement lo.r4 term 10 from protocol isis
set policy-options policy-statement lo.r4 term 10 from route-filter 2001:db8::4/128 exact
set policy-options policy-statement lo.r4 term 10 then accept
set policy-options policy-statement lo.r4 from protocol isis
set policy-options policy-statement lo.r4 from route-filter 4.4.4.4/32 exact
set policy-options policy-statement lo.r4 then accept
